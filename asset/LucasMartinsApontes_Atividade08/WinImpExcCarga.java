...
public class WinImpExcCarga implements ActionListener
{
	static WinImpExcCarga win = new WinImpExcCarga();
	...
	{
		if(manutenirCarga.veiculo.getSizeListaCarga() == 0)
		{
		...
		{
			for(int i = 0; i < manutenirCarga.veiculo.getSizeListaCarga(); i++)
			{
				carga = manutenirCarga.veiculo.getListaCarga(i);
				insetCargaTable(carga);
			}
	...
	public void insetCargaTable(Carga carga)
	{
	...
	{
		int sizeList = manutenirCarga.veiculo.getSizeListaCarga();
		...
		else
		{
			for(int i = 0; i < sizeList; i++)
			{
				...
				manutenirCarga.veiculo.excluirCadCarga(0);
			}
			JOptionPane.showMessageDialog(
				null,
