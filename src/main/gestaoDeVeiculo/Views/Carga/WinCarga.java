...
public class WinCarga implements ActionListener
{
	static WinCadCarga winCadCarga = new WinCadCarga();
	static WinGestaoDeVeiculo winMain = new WinGestaoDeVeiculo();
	static WinCarga win = new WinCarga();
	static WinImpExcCarga winImpExcCarga = new WinImpExcCarga();
	static WinCEPlacaCarga winCEPlacaCarga = new WinCEPlacaCarga();
	...
	public void setWinInit()
	{
		...
		win1.setTitle("Veículos de Carga");
	...
	public void setButtonInit()
	{
		...
		bt2Consultar.setBackground(green);
		bt2Consultar.setBounds(20, 60, 25, 25);
		bt3Imprimir.setBackground(green);
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		{
			winCadCarga.getCadCarga();
			win1.dispose();
		}
		if (evt.getSource().equals(bt2Consultar))
		{
			winCEPlacaCarga.getCEPlacaCarga();
			win1.dispose();
		}
		if (evt.getSource().equals(bt3Imprimir))
		{
			winImpExcCarga.getImpExcCarga();
			win1.dispose();
		}
