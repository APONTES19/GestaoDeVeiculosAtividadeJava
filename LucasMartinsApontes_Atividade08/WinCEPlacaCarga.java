...
public class WinCEPlacaCarga implements ActionListener
{
	static WinCEPlacaCarga win = new WinCEPlacaCarga();
	...
	public void setButtonInit()
	{
		...
		bt1Consultar.setBounds(20,430,90,40);
		...
		bt2Excluir.setBounds(125,430,80,40);
	...
	public void setCxsInit()
	{
		...
		cx10CargaMax.setBounds(180, 60, 210, 25);
		cx11Tara.setBounds(180, 100, 210, 25);
	...
	public void bt1ConsultarAct()
	{
		...
		{
			carga = manutenirCarga.pesqPlacaCarga(cx2Placa.getText());
			if (carga == null)
			{
			...
			else
			{
				...
				cx2Placa.setText(carga.getPlaca());
				cx10CargaMax.setText(String.valueOf(carga.getCargaMax()));
				cx11Tara.setText(String.valueOf(carga.getTara()));
				cx3Marca.setText(carga.getMarca());
				cx4Modelo.setText(carga.getModelo());
				cx5Cor.setText(carga.getCor());
				cx6QtdRodas.setText(String.valueOf(carga.getQtdRodas()));
				cx7VelocidadeMax.setText(String.valueOf(carga.getVelocMax()));
	...
	public void bt2ExcluirAct()
	{
		...
		{
			cx3Marca.setBackground(black);
			bt2Excluir.setVisible(false);
			return;
		}
		else
		{
			if( manutenirCarga.excluirPlacaCarga(cx2Placa.getText()) == 1 )
			{
				JOptionPane.showMessageDialog(
					null,
